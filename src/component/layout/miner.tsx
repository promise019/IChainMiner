    ...
    return (
        <section className="pt-20">
             <div className="flex flex-col items-center justify-center h-72 space-y-4">
              ...
              <div className="text-lg font-medium tracking-wide text-gray-200">Mining Simulation Running</div>
              ...
              <button className="mt-6 px-5 py-2 bg-green-700 hover:bg-green-600 rounded font-medium tracking-wide shadow-lg">Start / Stop</button>
            </div>
        </section>
    )
}